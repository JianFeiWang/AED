...
def data_crossver(cv_path,dict_path,eventlist,nfold):
	n = 0
	eventset = []
	nfold = int(nfold)
	names = locals()
...
if __name__ ==  '__main__':
	if len(sys.argv) != 5:
		exit('Usage: data_crossver.py <cv_path> <dict_path> <eventlist> <nfold>')
	data_crossver(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4])
